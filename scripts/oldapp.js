...
const rightNavArrow = document.getElementsByClassName("right-nav-arrows");
const leftNavArrow = document.getElementsByClassName("left-nav-arrows");

// const febHeaderElement = document.getElementById("february");
const febCalendar = document.getElementById("february-calendar");

// rightNavArrow.addEventListener("click", rightNavArrowClick);
// leftNavArrow.addEventListener("click", leftNavArrowClick);
...
function rightNavArrowClick() {
  console.log("clicked");
}

function leftNavArrowClick() {
  console.log("clicked");
}

// function showFeb(
// febCalendar.style.display = "";
// )
