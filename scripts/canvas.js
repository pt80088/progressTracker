...
// import * as datGui from "https://cdn.skypack.dev/dat.gui@0.7.7"; // imports gui controls for color and charset

const state = {
  fps: 8,
  color: "#0f0",
  charset: "0123456789ABCDEFHIJK%&$>}@",
};

// adds controls for color and charset to browser
